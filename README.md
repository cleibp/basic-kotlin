<h1 align="center"> 🚀 Kotlin Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem Kotlin
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-kotlin.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Kotlin) 
